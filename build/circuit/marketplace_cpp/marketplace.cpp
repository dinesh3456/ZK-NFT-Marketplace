...
void GreaterThanOrEqual_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void GreaterThanOrEqual_6_run(uint ctx_index,Circom_CalcWit* ctx);
void Multiply2_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Multiply2_7_run(uint ctx_index,Circom_CalcWit* ctx);
void NFTMarketplaceTransaction_8_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void NFTMarketplaceTransaction_8_run(uint ctx_index,Circom_CalcWit* ctx);
...
GreaterThan_4_run,
OR_5_run,
GreaterThanOrEqual_6_run,
Multiply2_7_run,
NFTMarketplaceTransaction_8_run };
...
uint get_total_signal_no() {return 306;}

uint get_number_of_components() {return 15;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 276;}
...
GreaterThan_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 260 ;
aux_cmp_num += 3;
}
...
ctx->componentMemory[coffset].templateName = "Multiply2";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 2;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
ctx->componentMemory[coffset].templateName = "NFTMarketplaceTransaction";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "priceCheck";
IsEqual_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "ownerCheck";
IsEqual_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "fundCheck";
GreaterThanOrEqual_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 272 ;
aux_cmp_num += 7;
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "mul1";
Multiply2_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 3 ;
aux_cmp_num += 1;
}
...
uint csoffset = mySignalStart+287;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "mul2";
Multiply2_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 3 ;
aux_cmp_num += 1;
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
GreaterThanOrEqual_6_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
// load src
Fr_sub(&expaux[0],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Multiply2_7_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
NFTMarketplaceTransaction_8_create(1,0,ctx,"main",0);
NFTMarketplaceTransaction_8_run(0,ctx);
}
